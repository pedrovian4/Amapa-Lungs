...
class TrainingPipeline:
    """Pipeline para treinamento e avaliação de diferentes modelos de classificação."""
        ...
        with ProcessPoolExecutor() as executor:
            ...
            for model_name, model in models.items():
                ...
                if not os.path.exists(model_path):
                    ...
                    futures[executor.submit(pipeline.run_model, model)] = model_name
                else:
            ...
            for future in as_completed(futures):
                ...
                try:
                    future.result()
                    print(Fore.GREEN + f"✅ Modelo {model_name} treinado e salvo com sucesso." + Style.RESET_ALL)
